<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === "POST"){
        ...
        $full_name = isset($_POST['full_name_c']) ? htmlspecialchars(trim($_POST['full_name_c'])) : '';
        $person_to_visit = isset($_POST['person_to_consult']) ? htmlspecialchars(trim($_POST['person_to_consult'])) : '';
        $visit_purpose = isset($_POST['consult_purpose']) ? htmlspecialchars(trim($_POST['consult_purpose'])) : '';
        $recaptcha = isset($_POST['recaptcha_c']) ? htmlspecialchars(trim($_POST['recaptcha_c'])) : '';
        ...
        if(!$response){
            ...
            $result = "Please enter a consultation purpose.";
            ...
            $mail_config = $config->set_config("consultation");
            ...
            if($logs->add_visitor_log($visitor_data) === true){
                ...
                if($mailer->public_mail($faculty->email, $faculty_name, $subject, $body2) === true){
                    ...
                    $success = true;
                    $result = "The person you want to consult has been notified successfully.";

            ...
            <nav class="navbar navbar-expand-lg sticky-top fs-5 shadow p-3 mb-2">
                <div class="container-fluid">
                    <a class="navbar-brand fw-bold" href="index" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
                        <img src="./assets/img/e-logbook.png" alt="Logo" width="60" height="60" class="d-inline-block align-text-center rounded-5"> <?= TITLE; ?>
                    </a>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-lg-12 col-md-12">
                                            ...
                                            <select type="text" class="form-control form-control-lg form-select mb-3" id="person_to_consult"></select>
                                        </div>
                                        <div class="col-sm-12 col-lg-12 col-md-12">
                                            <label for="consult_purpose">Purpose</label>
                                            <textarea type="text" class="form-control form-control-lg mb-3" id="consult_purpose"></textarea>
                                        </div>
                                    </div>
                                    <hr>
